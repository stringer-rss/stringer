required_env = {
  ...
  "POSTGRES_USER" => ENV.has_key?("POSTGRES_USER") ? ENV["POSTGRES_USER"] : "stringer",
  "POSTGRES_PASSWORD" => ENV.has_key?("POSTGRES_PASSWORD") ? ENV["POSTGRES_PASSWORD"] : `openssl rand -hex 32`.strip,
  "POSTGRES_HOSTNAME" => ENV.has_key?("POSTGRES_HOSTNAME") ? ENV["POSTGRES_HOSTNAME"] : "stringer-postgres",
  "POSTGRES_DB" => ENV.has_key?("POSTGRES_DB") ? ENV["POSTGRES_DB"] : "stringer",
  "FETCH_FEEDS_CRON" => "*/5 * * * *",
  "CLEANUP_CRON" => "0 0 * * *",
}
